...
export const BLESSINGS: BlessingData[] = [
  ...
  },
  {
    ...
    powers: [
      {
        name: 'Huelga Santa',
        description: 'En el primer nivel, puedes tocar un arma y bless con el poder de la pureza y la bondad. Durante 1 minuto, esta arma brilla en verde, blanco o amarillo dorado y causa 1d6 puntos adicionales de daño contra criaturas malvadas. Durante este tiempo, se trata como algo bueno con el propósito de superarlo reducción de daños. Este daño adicional no se combina con el daño adicional del santo habilidad especial del arma.',
        actionType: 'swift',
        costsFervor: false,
        unlocksAtLevel: 1,
      },
      {
        ...
        description: 'En el décimo nivel, puedes convocar Un compañero de batalla. Esta habilidad funciona como invocar monstruo IV con una duración de 1 minuto, pero sólo para un buen outsider o un animal con el criatura celestial plantilla sencilla. Esta habilidad puede convocar sólo una criatura, independientemente de la lista utilizada. Por cada 2 niveles más allá del décimo, el nivel del invocar monstruo el hechizo aumenta en 1 (hasta un máximo de invocar monstruo IX en el nivel 20)',
        actionType: 'swift',
        costsFervor: false,
        unlocksAtLevel: 10,
      },
    ...
    powers: [
      {
        ...
        description: 'En el 1er nivel, como acción rápida Puedes concentrar tu propia fuerza. Obtienes un Bono de mejora igual a 1/2 tu warpriest nivel (mínimo +1) en combate cuerpo a cuerpo rollos de ataque, maniobra de combate controles en los que se basa Fuerza, Fuerzahabilidades basadas en, y Fuerza cheques para 1 ronda.',
        actionType: 'swift',
        costsFervor: false,
        unlocksAtLevel: 1,
      },
      {
        ...
        description: 'En el décimo nivel, como acción rápida Puedes ignorar las penalizaciones de movimiento causadas por el uso medio o armadura pesada o portando una medio o carga pesada. Este efecto dura 1 minuto. Durante este tiempo, puedes agregar tu Fuerza modificador para guardar lanzamientos contra efectos que te harían convertirte en enredado, escalonado, o paralizado',
        actionType: 'swift',
        costsFervor: false,
        unlocksAtLevel: 10,
      },
