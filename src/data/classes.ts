...
export const CLASSES: ClassData[] = [
  {
    ...
    features: [
      ...
      { name: 'Trampa Sense', level: 2, description: '+1 a reflejos y CA contra trampas (mejora cada 3 niveles).' },
      { name: 'Reducción de Daño', level: 7, description: 'DR 1/— que mejora a DR 2/— en Nv10, 3/— en Nv13…' },
      ...
      { name: 'Poderes de Rabia Adicionales', level: 6, description: 'Ganas poderes de rabia adicionales (Nv6, 10, 14, 18).' },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Inspiración Valiente', level: 1, description: '+1 a tiradas de ataque y contra efectos de miedo (aumenta en Nv5, 11, 17).' },
      ...
      { name: 'Inspirar Competencia', level: 3, description: '+2 a tiradas de habilidad de aliados; mejora en Nv7, 11, 15, 19.' },
      { name: 'Sugerencia', level: 6, description: 'Puedes hacer una sugerencia a un objetivo fascinado.' },
      { name: 'Inspiración Heroica', level: 9, description: '+2 a tiradas de ataque y daño; mejora en Nv15.' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Resistencia a Veneno', level: 2, description: '+4 a TS contra venenos (mejora en Nv6, 10).' },
      { name: 'Movimiento en la Maleza', level: 2, description: 'Sin penalización por terreno difícil natural.' },
      { name: 'Rastrear', level: 2, description: '+1 a Supervivencia para rastrear (mejora cada 2 niveles).' },
      { name: 'Forma Salvaje', level: 4, description: 'Puedes transformarte en animal de talla P o M. Mejora en Nv6, 8, 10, 12.' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Talento de Combate', level: 1, description: 'Ganas un talento de combate adicional en Nv1 y cada 2 niveles (2, 4, 6…).' },
      { name: 'Valentía', level: 2, description: '+1 a TS contra efectos de miedo; mejora cada 4 niveles.' },
      { name: 'Entrenamiento de Armadura', level: 3, description: 'Reduces penalización de armadura en 1 y aumentas máx DES en 1 (mejora en Nv7, 11, 15).' },
      { name: 'Entrenamiento de Arma', level: 5, description: '+1 ataque y daño con grupo de armas elegido; mejora en Nv9, 13, 17.' },
  ...
  },
  {
    ...
    features: [
      { name: 'Golpe sin Arma', level: 1, description: 'Daño desarmado como monje; no provoca AoO. Daño escala con nivel.' },
      { name: 'Golpe Aturdidor', level: 1, description: 'Gasta 1 uso para aturdir o fatigar. Usos = nivel + mod SAB.' },
      { name: 'Bonificador de Armadura Natural', level: 1, description: '+1 CA cuando no se viste armadura (mejora en Nv4, 8, 12, 16, 20).' },
      ...
      { name: 'Caída Lenta', level: 4, description: 'Reduce la caída libre hasta 20 pies por nivel.' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Golpe del Paladín', level: 1, description: 'Gasta usos para añadir bono CAR a ataque/daño y HP temporales. Usos = 1 + por cada 2 niveles.' },
      ...
      { name: 'Misericordia', level: 3, description: 'Imponer Manos también elimina una condición negativa (mejora en Nv6, 9, 12…).' },
  ...
  },
  {
    ...
    features: [
      { name: 'Enemigo Favorito', level: 1, description: '+2 ataque, daño, Conocimiento, Percepción, Supervivencia vs tipo elegido. Mejora en Nv5, 9, 13, 17.' },
      ...
      { name: 'Terreno Favorito', level: 3, description: '+2 Iniciativa y bonificadores en terreno elegido; mejora en Nv8, 13, 18.' },
  ...
  },
  {
    ...
    features: [
      { name: 'Ataque Furtivo', level: 1, description: '+1d6 daño cuando el objetivo está desprevenido o flanqueado. Mejora en Nv3, 5, 7, 9, 11, 13, 15, 17, 19.' },
      { name: 'Trampa Sense', level: 1, description: 'Buscar trampas con tirada de Percepción. Activa Disable Device.' },
      { name: 'Evasión', level: 2, description: 'Con éxito en Reflejos, no sufres daño (falla = daño medio).' },
      { name: 'Trampa Sense +1', level: 3, description: '+1 a Reflejos y CA contra trampas (mejora en Nv6, 9, 12, 15, 18).' },
      { name: 'Movimiento Sigiloso', level: 4, description: 'No puedes ser flanqueado excepto por luchadores con más de 4 niveles.' },
      { name: 'Talentos de Pícaro', level: 2, description: 'Ganas un talento de pícaro menor en Nv2 y cada 2 niveles.' },
